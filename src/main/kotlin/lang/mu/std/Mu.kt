    ...
    when (member) {
        is KMutableProperty -> {
            ...
            return MuStdValue.func(
                ...
                try {
                    ...
                    val (_, r) = state.resolve(listOf(MuType.Constructor("lang.mu.std.Upcast", listOf(value.type, propertyType))))
        ...
        is KFunction -> {
            ...
            if (contextArg) {
                ...
                check(resultType.args[0] == MuType.Constructor("lang.mu.std.MuStdContext", emptyList()))
    ...
    companion object : InterpreterContext<MuStdContext, MuStdValue> {
        ...
        override fun liftList(context: MuStdContext, value: List<MuStdValue>): MuStdValue {
            ...
            val (newState, resolved) = state.resolve(value.map {
                MuType.Constructor("lang.mu.std.Upcast", listOf(it.type, unificationVar))
            })
