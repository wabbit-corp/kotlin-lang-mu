...
// managed-integrity-v1: ftb9Unioj1D
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-lang-mu", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-lang-mu")
        description.set("kotlin-lang-mu")
        url.set("https://github.com/wabbit-corp/kotlin-lang-mu")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-lang-mu")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-lang-mu.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-lang-mu.git")
        }
    }
}
