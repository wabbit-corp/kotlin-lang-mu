...
- Canonical repo target: `kotlin-lang-mu`. Useful entrypoints: `dev project show kotlin-lang-mu`, `dev build kotlin-lang-mu`, `dev check kotlin-lang-mu`.
- Setup-managed files are regenerated with `dev setup kotlin-lang-mu`; avoid hand-editing stamped generated files.
